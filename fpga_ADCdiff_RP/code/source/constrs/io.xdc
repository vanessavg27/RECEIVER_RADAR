...
# ADC data
set_property IOSTANDARD DIFF_SSTL18_II [get_ports {adc_dat_?_?_i[*]}]
set_property IOB TRUE [get_ports {adc_dat_?_?_i[*]}]
...
# data
set_property IOSTANDARD LVCMOS33 [get_ports {dac_dat_?[*]}]
set_property SLEW FAST [get_ports {dac_dat_?[*]}]
set_property DRIVE 8 [get_ports {dac_dat_?[*]}]
set_property IOB TRUE [get_ports {dac_dat_?[*]}]

set_property PACKAGE_PIN L19 [get_ports {dac_dat_a[0]}]
set_property PACKAGE_PIN L20 [get_ports {dac_dat_a[1]}]
set_property PACKAGE_PIN K19 [get_ports {dac_dat_a[2]}]
set_property PACKAGE_PIN J19 [get_ports {dac_dat_a[3]}]
set_property PACKAGE_PIN J20 [get_ports {dac_dat_a[4]}]
set_property PACKAGE_PIN J18 [get_ports {dac_dat_a[5]}]
set_property PACKAGE_PIN H20 [get_ports {dac_dat_a[6]}]
set_property PACKAGE_PIN G19 [get_ports {dac_dat_a[7]}]
set_property PACKAGE_PIN G20 [get_ports {dac_dat_a[8]}]
set_property PACKAGE_PIN F17 [get_ports {dac_dat_a[9]}]
set_property PACKAGE_PIN F20 [get_ports {dac_dat_a[10]}]
set_property PACKAGE_PIN F19 [get_ports {dac_dat_a[11]}]
set_property PACKAGE_PIN D20 [get_ports {dac_dat_a[12]}]
set_property PACKAGE_PIN D19 [get_ports {dac_dat_a[13]}]

set_property PACKAGE_PIN G18 [get_ports {dac_dat_b[0]}]
set_property PACKAGE_PIN G17 [get_ports {dac_dat_b[1]}]
set_property PACKAGE_PIN H17 [get_ports {dac_dat_b[2]}]
set_property PACKAGE_PIN H18 [get_ports {dac_dat_b[3]}]
set_property PACKAGE_PIN J16 [get_ports {dac_dat_b[4]}]
set_property PACKAGE_PIN K16 [get_ports {dac_dat_b[5]}]
set_property PACKAGE_PIN K17 [get_ports {dac_dat_b[6]}]
set_property PACKAGE_PIN L15 [get_ports {dac_dat_b[7]}]
set_property PACKAGE_PIN M20 [get_ports {dac_dat_b[8]}]
set_property PACKAGE_PIN M19 [get_ports {dac_dat_b[9]}]
set_property PACKAGE_PIN M17 [get_ports {dac_dat_b[10]}]
set_property PACKAGE_PIN M18 [get_ports {dac_dat_b[11]}]
set_property PACKAGE_PIN L17 [get_ports {dac_dat_b[12]}]
set_property PACKAGE_PIN K18 [get_ports {dac_dat_b[13]}]
...
#set_property PACKAGE_PIN W8 [get_ports {gpio_10}]
...
#set_property PACKAGE_PIN Y12 [get_ports {gpio_250}]
